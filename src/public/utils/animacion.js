...
const framePath = '/media/animacion_frames_p/video-bienvenida_0'; // <--- ¡Asegura que el slash inicial sea correcto!
const frameExtension = '.jpg'; // <--- CAMBIADO a .jpg según tu descripción y frames enviados
