                ...
                if (!user.id_carrera) {
                    ...
                    rankingCarreraContainer.innerHTML += `
                        <div style="color: red; text-align: center; padding: 20px;">
                            ...
                            <p>Por favor, contacta al administrador para asignar una carrera a tu cuenta.</p>
                        </div>
                    `;
                    return;
                }
