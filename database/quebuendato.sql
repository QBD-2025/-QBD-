...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-08-2025 a las 04:14:32
...
--
-- Volcado de datos para la tabla `dato_curioso`
--

INSERT INTO `dato_curioso` (`id_dato`, `id_materia`, `dato`, `imagen`, `fuente`) VALUES
(164, 16, 'El grito que no dio Hidalgo: Miguel Hidalgo no tocó la famosa “Campana de la Independencia”; quien lo hizo fue el campanero José Galván.', NULL, 'Excursiones Riviera Maya'),
(165, 16, 'El meteorito de los dinosaurios\r\nEl cráter del meteorito que provocó la extinción de los dinosaurios está en Chicxulub, Yucatán, México.', NULL, 'Excursiones Riviera Maya'),
(166, 16, 'El primer presidente ciudadano\r\nSebastián Lerdo de Tejada fue el primer presidente de México que nació en territorio mexicano, no en la Nueva España.', NULL, 'Excursiones Riviera Maya'),
(167, 16, 'Un solo castillo en toda América\r\nEl Castillo de Chapultepec es el único castillo construido en el continente americano.', NULL, 'Excursiones Riviera Maya'),
(168, 16, 'México, “ombligo de la luna”\r\nEl nombre “México” proviene de las palabras náhuatl “Metztli” (luna) y “xictli” (ombligo).', NULL, 'Excursiones Riviera Maya'),
(169, 16, 'La independencia y sus 50 gobiernos\r\nMéxico tuvo 50 gobiernos diferentes entre 1821 y 1850, después de lograr su independencia.', NULL, 'Excursiones Riviera Maya'),
(170, 16, 'La primera televisión a color\r\nEl mexicano Guillermo González Camarena inventó el primer sistema para la televisión a color a los 23 años.', NULL, 'Excursiones Riviera Maya'),
(171, 16, 'Sacrificios poco comunes en Canaán\r\nHace 4,500 años, en una ciudad cananea, se sacrificaron burras egipcias según recientes excavaciones.', NULL, 'National Geographic Historia'),
(172, 16, 'Werther y la ola de suicidios\r\nLa novela “Werther” de Goethe impulsó una ola de suicidios entre jóvenes europeos durante el siglo XVIII.', NULL, 'Psicología y Mente'),
(173, 16, 'Juegos olímpicos con medallas de arte\r\nEn los antiguos Juegos Olímpicos se otorgaban medallas también por arquitectura, música y pintura.', NULL, 'Autopista'),
(174, 9, 'Lago rosado en Australia\r\nEl Lago Hillier, en Australia, tiene un color rosa intenso debido a microorganismos y sal.', NULL, 'Escuela en Línea N1'),
(175, 1, 'El número π tiene su propio día\r\nCada 14 de marzo se celebra el Día de Pi (π), por su notación 3/14.', NULL, 'Smartick, YouTube'),
(176, 9, 'Punto Nemo: el lugar más aislado\r\nEl Punto Nemo es el lugar más remoto del planeta, a más de 2,600km de cualquier costa.', NULL, 'Escuela en Línea N1'),
(177, 1, 'El cero fue el último número en crearse\r\nEl número cero fue uno de los últimos en agregarse a los sistemas numéricos, fundamental para la aritmética moderna.', NULL, 'Red Educa, YouTube'),
(178, 9, 'Canadá y sus millones de lagos\r\nCanadá posee más lagos que todo el resto del mundo combinado: más de 3 millones.', NULL, 'Escuela en Línea N1'),
(179, 1, 'Los egipcios usaban fracciones en las pirámides\r\nLos egipcios resolvieron problemas de construcción usando fracciones hace miles de años.', NULL, 'YouTube'),
(180, 9, 'El desierto más grande no es de arena\r\nLa Antártida es el desierto más grande del mundo, ya que es la región más seca de la Tierra.', NULL, 'Escuela en Línea N1'),
(181, 1, 'Un “googol” tiene 100 ceros\r\nLa palabra “googol” es un 1 seguido por 100 ceros y dio nombre a Google.', NULL, 'YouTube'),
(182, 9, 'Río hirviente en la Amazonía\r\nEl Shanay-Timpishka, en Perú, puede alcanzar 93°C y es uno de los pocos ríos hirvientes del mundo.', NULL, 'Escuela en Línea N1'),
(183, 1, 'La raíz cuadrada se simbolizaba con ‘r’\r\nEl símbolo de la raíz cuadrada originalmente era una “r” alargada, de la palabra “radix”.', NULL, 'YouTube'),
(184, 1, 'El álgebra de Baldor, famosa en Latinoamérica\r\nEscrita por Aurelio Baldor, un cubano, su portada muestra a Al-Juarismi, padre del álgebra.', NULL, 'YouTube'),
(185, 9, 'Monte Everest: el techo del mundo\r\nEl Everest es el punto más alto del planeta, con 8,849 metros sobre el nivel del mar.', NULL, 'Psicología y Mente'),
(186, 1, 'El plano cartesiano nació en la cama\r\nDescartes inventó el plano cartesiano observando una mosca en el techo mientras estaba acostado.', NULL, 'YouTube'),
(187, 9, 'Río Amazonas: el más caudaloso\r\nEl Amazonas expulsa 200,000m³ de agua por segundo, siendo el más caudaloso de la Tierra.', NULL, 'Psicología y Mente'),
(188, 1, 'Multiplicación era solo para universitarios\r\nHasta el siglo XVI, las multiplicaciones se enseñaban solo en universidades por su complejidad.', NULL, 'YouTube'),
(189, 9, 'Lago de Constanza: frontera triple flotante\r\nEl Lago de Constanza, en Europa, marca la frontera entre Alemania, Austria y Suiza, pero en muchas zonas no hay una división oficial.', NULL, 'Muy Interesante'),
(190, 1, 'El número perfecto 2,520\r\nEl número 2,520 es divisible exactamente por todos los números del 1 al 10.', NULL, 'YouTube'),
(191, 1, 'Pi podría rodear la Tierra\r\nSi escribieras las 31 billones de cifras decimales de π en letra pequeña, daría la vuelta a la Tierra 155 veces.', NULL, 'YouTube'),
(192, 9, 'Islas Diómedes: el mañana y el ayer\r\nLas islas Diómedes están separadas por la Línea Internacional de Cambio de Fecha: entre ambas siempre hay casi un día de diferencia.', NULL, 'Muy Interesante'),
(193, 13, 'La primera webcam era para café\r\nLa primera cámara web se creó en Cambridge para monitorear una cafetera en los años 90.', NULL, 'Universidad IUM'),
(194, 9, 'La montaña más alta desde el centro de la Tierra\r\nEl Chimborazo (Ecuador) es el punto más alejado del centro de la Tierra, más que el Everest, por el abultamiento ecuatorial.', NULL, 'Muy Interesante'),
(195, 13, 'El primer dominio de Internet\r\nSymbolics.com fue el primer dominio registrado, el 15 de marzo de 1985.', NULL, 'Universidad IUM'),
(196, 13, 'El primer tuit del mundo\r\nEl 21 de marzo de 2006 salió el primer mensaje en Twitter: “just setting up my twttr”.', NULL, 'Universidad IUM'),
(197, 13, 'Virus informáticos: 12 cada segundo\r\nCada segundo, se crean doce nuevos virus informáticos en el mundo, según Kaspersky.', NULL, 'Universidad IUM'),
(198, 18, 'Superposición cuántica: estar en dos lugares\r\nLas partículas pueden existir en varios estados a la vez, según la física cuántica.', NULL, 'Muy Interesante'),
(199, 13, 'Robert Morris y el “gusano” pionero\r\nEl primer “gusano” informático fue creado en 1988 e inspiró los ataques DDoS modernos.', NULL, 'Universidad IUM'),
(200, 18, 'El sorprendente efecto túnelLas partículas pueden “atravesar” barreras de energía imposibles según la física clásica.', NULL, 'Muy interesante'),
(201, 13, 'El logo original de Apple era muy distinto\r\nEl primer logo de Apple mostraba a Newton bajo un manzano, totalmente diferente al actual.', NULL, 'BBC Mundo'),
(202, 13, 'El mouse fue de madera\r\nEl primer ratón de computadora era de madera y lo inventó Douglas Engelbart en 1964.', NULL, 'Infordisa'),
(203, 13, 'La mascota de Firefox no es un zorro\r\nLa figura de Mozilla Firefox es un panda rojo, no un zorro como muchos suponen.', NULL, 'Digitalizatec'),
(204, 13, 'El “robot” y su origen checo\r\nLa palabra “robot” proviene del checo “robota”, que significa trabajo forzado.', NULL, 'Digitalizatec'),
(205, 13, 'Primer video de YouTube en el zoológico\r\n“Me at the Zoo” fue el primer video subido a YouTube el 23 de abril de 2005, grabado por uno de sus fundadores.', NULL, 'Universidad IUM'),
(206, 18, 'El gato de Schrödinger: vivo y muerto\r\nEl famoso experimento mental ilustra la superposición cuántica con un gato teórico que puede estar vivo y muerto a la vez en una caja.', NULL, 'Muy Interesante'),
(207, 18, 'Superconductividad: electricidad sin resistencia\r\nCiertos materiales transmiten electricidad sin pérdida de energía a temperaturas muy bajas.', NULL, 'Muy Interesante'),
(208, 2, 'El agua puede existir en tres estados juntos\r\nEn condiciones específicas se puede observar el punto triple, donde el agua coexiste como sólido, líquido y gas.', NULL, 'Royal Society of Chemistry'),
(209, 2, 'El oro es químicamente inerte\r\nEl oro no reacciona fácilmente con otros elementos, por eso es resistente a la corrosión y oxidación.', NULL, 'Chemguide'),
(210, 18, 'El tiempo avanza más rápido al subir\r\nPor la relatividad, cuanto más alto te encuentras, más rápido pasa el tiempo respecto al nivel del mar.', NULL, 'Cuales'),
(211, 2, 'El grafeno es un supermaterial\r\nEl grafeno es una capa de carbono de un átomo de grosor, con alta resistencia y conductividad eléctrica.', NULL, 'Nature Nanotechnology'),
(212, 2, 'El helio no se solidifica a presión normal\r\nEl helio es el único gas que no se solidifica al enfriarse a presión atmosférica, necesita presiones altas.', NULL, 'American Chemical Society'),
(213, 18, 'La gravedad curva el tiempo\r\nEn presencia de mayor gravedad, el tiempo pasa más lentamente.', NULL, 'Univision'),
(214, 2, 'Los nanotubos de carbono son muy fuertes\r\nSon hasta 100 veces más resistentes que el acero pero mucho más livianos.', NULL, 'Scientific American'),
(215, 2, 'Los átomos son en su mayoría espacio vacío\r\nUn átomo está compuesto por un núcleo diminuto y una nube de electrones donde casi todo es espacio vacío.', NULL, 'Physics Today'),
(216, 18, 'El primer físico fue griego\r\nAnaxágoras, 500 a.C., es considerado el primer físico por intentar explicar el cambio en la naturaleza.', NULL, 'Adelante'),
(217, 2, 'El ácido fluorhídrico disuelve vidrio\r\nA diferencia de otros ácidos, el HF puede reaccionar con el silicio del vidrio y disolverlo.', NULL, 'Royal Society of Chemistry'),
(218, 2, 'La química verde busca sostenibilidad\r\nEste campo estudia procesos químicos que minimizan impactos ambientales y usan menos recursos tóxicos.', NULL, 'Green Chemistry Journal'),
(219, 18, 'Pantallas y el efecto piezoeléctrico\r\nLas pantallas táctiles funcionan gracias a materiales piezoeléctricos que generan electricidad al presionarlos.', NULL, 'Cuales'),
(220, 2, 'La tabla periódica tiene 118 elementos\r\nEl último elemento oficialmente nombrado es el oganesón (Og), descubierto en 2002 y confirmado en 2015.', NULL, 'IUPAC'),
(221, 18, 'Leyes de Newton en los autos\r\nLos airbags funcionan aplicando la segunda ley de Newton, relacionando masa, aceleración y fuerza.', NULL, 'Cuales'),
(222, 2, 'Los catalizadores no se consumen\r\nUn catalizador acelera reacciones químicas sin cambiar su propia composición.', NULL, 'Khan Academy'),
(223, 20, 'El cerebro procesa imágenes en 13 ms\r\nLa corteza visual humana puede reconocer y procesar una imagen en apenas 13 milisegundos.', NULL, 'Frontiers in Human Neuroscience'),
(224, 20, 'El efecto placebo funciona realmente\r\nEl cerebro puede crear respuestas fisiológicas reales ante tratamientos sin principios activos.', NULL, 'Harvard Health Publishing'),
(225, 18, 'El universo observable tiene 13,800 millones de años\r\nLa edad calculada del universo: unos 13,800 millones de años tras el Big Bang.', NULL, 'Cuales'),
(226, 20, 'Las emociones cambian el cuerpo\r\nLas emociones tienen efectos medibles en el sistema inmunológico y cardiovascular.', NULL, 'American Psychological Association'),
(227, 20, 'El sueño consolida la memoria\r\nDormir ayuda a fijar recuerdos y aprendizajes realizados durante el día.', NULL, 'National Sleep Foundation'),
(228, 20, 'La plasticidad cerebral dura toda la vida\r\nEl cerebro puede reorganizarse y adaptarse a nuevas experiencias durante toda la vida.', NULL, 'Journal of Neuroscience'),
(229, 20, 'La risa reduce el estrés\r\nReír libera endorfinas y reduce hormonas del estrés, mejorando el bienestar mental.', NULL, 'Mayo Clinic'),
(230, 20, 'El sesgo de confirmación afecta decisiones\r\nLas personas tienden a buscar información que confirma sus creencias, ignorando datos contradictorios.', NULL, 'Psychological Science'),
(231, 20, 'Los colores afectan el ánimo\r\nEl rojo puede aumentar la energía, mientras el azul tiende a relajar y reducir la presión arterial.', NULL, 'Journal of Environmental Psychology'),
(232, 17, 'El ADN humano es 99.9% igual\r\nEl ADN de todos los seres humanos es casi idéntico, con una variación menor al 0.1%, que es lo que nos hace únicos.', NULL, 'National Geographic'),
(233, 20, 'El mindfulness disminuye la ansiedad\r\nPrácticas de atención plena reducen síntomas de ansiedad y mejoran la concentración.', NULL, 'JAMA Psychiatry'),
(234, 20, 'El contacto físico mejora la empatía\r\nEl tacto aumenta las respuestas emocionales positivas y fortalece relaciones sociales.', NULL, 'University of Oxford'),
(235, 17, 'Las células se comunican constantemente\r\nLas células de nuestro cuerpo envían señales químicas de forma continua para coordinar funciones vitales, como respuesta al estrés o al daño.', NULL, 'Science Daily'),
(236, 17, 'El corazón tiene su propio sistema nervioso\r\nEl corazón posee un sistema nervioso propio llamado \"cerebro cardíaco\", capaz de tomar decisiones independientes del cerebro principal.', NULL, 'Harvard Health Publishing'),
(237, 17, 'Las bacterias superan en número a las células\r\nEn el cuerpo humano hay más bacterias que células, estimándose alrededor de 39 billones de bacterias frente a 30 billones de células.', NULL, 'Nature Reviews Microbiology'),
(238, 17, 'Los tardígrados sobreviven en el espacio\r\nEstos microanimales pueden sobrevivir condiciones extremas, incluso el vacío y radiación espacial.', NULL, 'NASA'),
(239, 17, 'El ADN puede durar miles de años\r\nSe han recuperado muestras de ADN viables de restos humanos y animales con miles de años de antigüedad.', NULL, 'National Geographic'),
(240, 17, 'La fotosíntesis creó el oxígeno actual\r\nLa fotosíntesis, realizada por las cianobacterias hace 2,500 millones de años, fue clave para la atmósfera rica en oxígeno.', NULL, 'Smithsonian Science Education Center'),
(241, 17, 'Los músculos más fuertes no son los de las piernas\r\nEl músculo más fuerte en función de fuerza relativa es el masetero, el músculo de la mandíbula.', NULL, 'American Physiological Society'),
(242, 17, 'El cerebro puede generar nuevas neuronas\r\nContrario a lo que se creía, el cerebro adulto puede producir neuronas en ciertas áreas, como el hipocampo.', NULL, 'Journal of Neuroscience'),
(243, 17, 'Las plantas ‘sienten’ el ambiente\r\nLas plantas pueden detectar cambios en la luz, el tacto y liberar sustancias químicas para defenderse.', NULL, 'Science Magazine'),
(244, 19, 'El universo tiene 13,800 millones de años\r\nEl Big Bang marca el comienzo del universo hace aproximadamente 13.8 mil millones de años.', NULL, 'NASA'),
(245, 19, 'Un día en Venus dura más que un año\r\nVenus tarda más en rotar sobre su eje (243 días terrestres) que en orbitar al Sol (225 días).', NULL, 'ESA'),
(246, 19, 'Las estrellas no parpadean en el espacio\r\nEl fenómeno del parpadeo es causado por la atmósfera terrestre, en el espacio las estrellas son fijas.', NULL, 'NASA'),
(247, 19, 'El agujero negro más cercano está a 1,000 años luz\r\nSe llama Gaia BH1 y fue detectado en 2022 cerca de nuestro sistema solar.', NULL, 'Harvard-Smithsonian Center for Astrophysics'),
(248, 19, 'Las lunas de Júpiter son volcánicas\r\nIo, una luna de Júpiter, es el cuerpo más volcánico del sistema solar, con erupciones constantes.', NULL, 'NASA'),
(249, 19, 'La luz tarda 8 minutos en llegar del Sol a la Tierra\r\nLa luz solar viaja a 300,000 km/s y tarda aproximadamente 8 minutos y 20 segundos para llegar a nosotros.', NULL, 'ESA'),
(250, 19, 'Existen exoplanetas habitables\r\nSe han descubierto varios exoplanetas en la “zona habitable” de sus estrellas, donde podría existir agua líquida.', NULL, 'NASA Exoplanet Archive'),
(251, 19, 'La materia oscura compone 27% del universo\r\nAunque no visible, la materia oscura afecta la gravitación y expansión del universo.', NULL, 'CERN'),
(252, 19, 'El universo se está expandiendo más rápido\r\nMediciones recientes indican que la tasa de expansión del universo es acelerada.', NULL, 'NASA'),
(253, 19, 'Un día en Marte dura casi 24.6 horas\r\nEl día marciano es solo 40 minutos más largo que un día terrestre.', NULL, 'NASA'),
(254, 21, 'Talleres de momificación en Egipto\r\nEn Saqqara, se descubrieron talleres de momificación con instrumentos y lechos de piedra del periodo ptolemaico.', NULL, 'National Geographic'),
(255, 21, 'Monolito de Coyolxauhqui, clave mexicana\r\nHallado en 1978, reveló la ubicación exacta del Templo Mayor en Ciudad de México.', NULL, 'INAH México'),
(256, 21, 'Gran Tzompantli, torre de cráneos\r\nEn 2015 se descubrió una plataforma con 350 cráneos humanos vinculados a sacrificios mexicas.', NULL, 'INAH México'),
(257, 21, 'Máscara de jade maya antigua\r\nEn Guatemala, se encontró una máscara de jade de 1,650 años que aporta datos sobre la sociedad maya.', NULL, 'Finestresullarte.info'),
(258, 21, 'Templo sumergido en Italia\r\nUn templo romano de hace 2,000 años fue hallado bajo el agua, construido por comerciantes del desierto árabe.', NULL, 'National Geographic'),
(259, 21, 'Ciudad maya invisible con láser\r\nTecnología láser reveló una ciudad maya perdida entre la selva, con plazas y calzadas monumentales.', NULL, 'National Geographic'),
(260, 21, 'Máscaras y estatuillas egipcias\r\nEn Luxor, se encontraron estatuillas de dioses y faraones con inscripciones jeroglíficas.', NULL, 'Universidad Pablo de Olavide'),
(261, 21, 'Necrópolis prerromana en Italia\r\nEn Benevento, se descubrió una necrópolis con tumbas que datan del periodo prerromano.', NULL, 'Finestresullarte.info'),
(262, 21, 'Muelle prehispánico en Michoacán\r\nHallaron una lancha tradicional y huesos humanos asociados a ofrendas en el Lago de Pátzcuaro.', NULL, 'INAH México'),
(263, 21, 'Fragmento Porticus Minucia en Roma\r\nUn importante edificio plebeyo romano fue parcialmente descubierto durante remodelación en 2024.', NULL, 'Finestresullarte.info');
...
(38, 'Daniel', 'danielviramontes562@gmail.com', '$2b$10$d1hj5RO7GIBbSdLjNLq2QuMVukUQe4ORySBIJJ4mlK223ARbZgw.u', 1, NULL, NULL, NULL, 0, 3, 2, NULL, NULL),
...
(69, 'Test', 'testingh569@gmail.com', '', 1, NULL, NULL, NULL, 0, 3, 1, NULL, NULL),
(70, 'Daniel', 'danielviramontes762@gmail.com', '$2b$10$DOzb79X0MvL8GLQD.9XlMuHQi3Fj7lMNyPdT5luCVXdyRZYGu/DBO', 1, NULL, NULL, NULL, 0, 1, 2, NULL, NULL);
...
--
ALTER TABLE `dato_curioso`
  MODIFY `id_dato` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=264;
...
--
-- Base de datos: `quebuendato2`
--
CREATE DATABASE IF NOT EXISTS `quebuendato2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `quebuendato2`;
