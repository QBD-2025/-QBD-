/* ================================================================
  Archivo: animacion6.js
  Descripción: Controla la animación del modo competitivo,
incluyendo precarga de frames y reproducción al pasar el cursor o hacer clic.
  Autor: Equipo de desarrollo
  Última modificación: 12 de octubre de 2025
   ================================================================ */
   ...
   document.addEventListener('DOMContentLoaded', function() {
     ...
     // ===== ELEMENTOS DEL DOM =====
     const animationElement = document.getElementById('duolingoAnimation6'); // Imagen donde se mostrará la animación
     ...
     const framesPerStep = 5; // Cada cuántos frames reales se actualiza la imagen
     const introStartFrameNum = 1; // Primer frame de la animación
     const introEndFrameNum = 188; // Último frame de la animación
     ...
     const framePath = '/media/animacion-competitivo/animacion-competitivo_'; // Ruta base de las imágenes
     ...
     function initAnimation() {
       ...
       introTimeline.to(animationElement, {
         duration: introTotalImages / 10, // Duración proporcional al número de frames
     ...
     framesToLoad.forEach(frameNumber => {
       ...
       img.src = framePathFull; // Asignamos la ruta del frame
