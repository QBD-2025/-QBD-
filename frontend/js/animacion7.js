/* ================================================================
Archivo: animacion7.js
Descripción: Controla la animación de "video clasifica",
incluyendo precarga de frames y reproducción al pasar el cursor o hacer clic.
  ...
  console.log('🚀 Script JS iniciado');
   ...
   document.addEventListener('DOMContentLoaded', function() {
     ...
     // ===== ELEMENTOS DEL DOM =====
     const animationElement = document.getElementById('duolingoAnimation7'); // Imagen donde se mostrará la animación
     ...
     if (!animationElement) {
       console.error('No se encontró el elemento con id "duolingoAnimation7" en el DOM.');
     ...
     const introStartFrameNum = 8; // Primer frame de la animación
     ...
     const framePath = '/media/video_clasifica/frame-'; // Ruta base de las imágenes
