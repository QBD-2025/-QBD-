/* ================================================================
   ...
   Descripción: Controla la animación de "caminando Stuart Octavio",
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // ===== ELEMENTOS DEL DOM =====
  const animationElement = document.getElementById('duolingoAnimation3'); // Imagen donde se mostrará la animación
  ...
  if (!animationElement) {
    console.error('No se encontró el elemento con id "duolingoAnimation3" en el DOM.');
  ...
  const introEndFrameNum = 71; // Último frame de la animación
  ...
  const framePath = '/media/caminando_stuart_octavio/caminando_stuart_octavio_'; // Ruta base de las imágenes
