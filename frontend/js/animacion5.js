/* ================================================================
Archivo: animacion5.js
Descripción: Controla la animación de "video admisión", incluyendo
...
================================================================ */
  ...
  console.log('🚀 Script JS iniciado');
   ...
   document.addEventListener('DOMContentLoaded', function() {
     ...
     // ===== ELEMENTOS DEL DOM =====
     const animationElement = document.getElementById('duolingoAnimation5'); // Imagen donde se mostrará la animación
     ...
     if (!animationElement) {
       console.error('No se encontró el elemento con id "duolingoAnimation5" en el DOM.');
